...
return [
  ...
  */
  ...
  // Daftar IP yang boleh membuka halaman display buku tamu (layar antrean di
  // kantor). Dibaca middleware AllowCertainIpOnly.
  ...
  */
  ...
  'name' => env('APP_NAME', 'Dinas Pekerjaan Umum dan Penataan Ruang Kota Samarinda'),
