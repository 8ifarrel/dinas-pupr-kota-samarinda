...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 07 Jul 2025 pada 08.00
...
('5c785c036466adea360111aa28563bfd556b5fba', 'i:1;', 1751856347),
('5c785c036466adea360111aa28563bfd556b5fba:timer', 'i:1751856347;', 1751856347);
...
CREATE TABLE `kepala_dinas` (
  ...
  `id_susunan_organisasi` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `kepala_dinas` (`id`, `nama`, `foto`, `nip`, `nomor_telepon`, `golongan`, `tahun_mulai`, `tahun_selesai`, `id_susunan_organisasi`, `created_at`, `updated_at`) VALUES
(1, 'Desy Damayanti, S.T., M.T.', 'kepala-dinas/desy-damayanti-st-mt.png', '0000', '000000', 'I/a', '2021', '2026', 1, '2025-06-29 11:12:08', '2025-06-29 11:12:08');
...
INSERT INTO `kepala_dinas_jenjang_karir` (`id_karir`, `id_kepala_dinas`, `nama_karir`, `tanggal_masuk`, `id_susunan_organisasi`, `created_at`, `updated_at`) VALUES
(304, NULL, 'Kepala UPTD Perawatan Laboratorium', '2009-04-29', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55'),
(305, NULL, 'Kepala Bidang Bina Teknik', '2014-02-07', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55'),
(306, NULL, 'Kepala Bidang Pengendalian Banjir', '2014-10-09', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55'),
(307, NULL, 'Kepala Bidang Pemukimansasa', '2017-01-18', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55'),
(308, NULL, 'Kepala Bidang Pelaksanaan Jaringan Sumber Air', '2017-12-06', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55'),
(309, NULL, 'Sekretaris DPUPR Kota Samarinda', '2021-04-27', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55');
...
INSERT INTO `kepala_dinas_riwayat_pendidikan` (`id_pendidikan`, `id_kepala_dinas`, `nama_pendidikan`, `tanggal_masuk`, `id_susunan_organisasi`, `created_at`, `updated_at`) VALUES
(230, NULL, 'SD Negeri 005', '1992-08-01', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55'),
(231, NULL, 'SMP Negeri 1 Samarinda', '1992-08-02', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55'),
(232, NULL, 'SMA Negeri 1 Malang', '1992-08-03', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55'),
(233, NULL, 'Universitas Institut Teknologi Nasional Malang Program Studi Teknik Sipil Perencanaan', '1992-08-04', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55'),
(234, NULL, 'Institut Teknologi Sepuluh Nopember Program Magister Teknik Sipil-Manajemen Aset', '1992-08-05', 1, '2025-07-02 22:24:55', '2025-07-02 22:24:55');
...
(30, '2024_05_29_104157_kepala_dinas', 13),
(31, '2024_05_25_104157_kepala_dinas', 14),
(32, '2023_07_01_000001_add_id_kepala_dinas_to_riwayat_pendidikan_jenjang_karir', 15);
...
(1, 1, 'Mewujudkan masyarakat kota yang religious, unggul dan berbudaya', '2021', '2026', '2025-07-03 02:04:43', '2025-07-03 02:04:43'),
(2, 2, 'Mewujudkan perekonomian kota yang maju, mandiri, berkerakyatan dan berkeadilan', '2021', '2026', '2025-07-03 02:04:43', '2025-07-03 02:04:43'),
(3, 3, 'Mewujudkan pemerintahan yang professional, transparan, akuntabel dan bebas korupsi dengan memberi ruang bagi partisipasi masyarakat', '2021', '2026', '2025-07-03 02:04:43', '2025-07-03 02:04:43'),
(4, 4, 'Mewujudkan infrastruktur yang mantap dan modern', '2021', '2026', '2025-07-03 02:04:43', '2025-07-03 02:04:43'),
(5, 5, 'Mewujudkan lingkungan kota yang aman, nyaman, harmoni dan lestari', '2021', '2026', '2025-07-03 02:04:43', '2025-07-03 02:04:43');
...
(1, 'Partner/1.png', 'Sistem Informasi Rencana Umum Pengadaan', 'https://sirup.lkpp.go.id', '2025-01-14 01:09:21', '2025-06-29 04:57:13'),
...
(5, 'partner/5.png', 'Sistem Informasi Pemerintahan Daerah Republik Indonesia', 'https://sipd.kemendagri.go.id/', '2024-12-13 19:52:15', '2024-12-13 19:52:15');
...
(2, 'PERPANJANGAN KONTRAK KERJA PTTB TAHUN 2019', 'perpanjangan-kontrak-kerja-pttb-tahun-2019', '<div>Sehubungan dengan Surat edaran Sekretariat Daerah Kota Samarinda Nomor : 800/4870/300.04 tentang perpanjangan Kontrak Pegawai PTTB Dilingkungan Pemkot Samarinda Tahun 2019 maka disampaikan sebagai berikut :&nbsp;</div><div>1. Agar setiap Kepala Bidang / Seksi / dapat menyeleksi seluruh pegawai PTTB yang berada dibawah pembinaannya selanjutnya membuat rekomendasi perpanjangan Kontrak PTTB.</div><div>2. Rekomendasi tersebut diatas dikumpul pada bagian umum Sekretariat Dinas Perdagangan Kota Samarinda paling lambat tanggal 26 Nopember 2018, dengan melampirkan persyaratan yang disyaratkan</div>', NULL, 401, '2018-11-15 16:17:31', '2025-07-03 04:25:25'),
(3, 'Revisi Rencana Tata Ruang Wilayah Kota (RTRW) Kota Samarinda', 'revisi-rencana-tata-ruang-wilayah-kota-rtrw-kota-samarinda', '<div>Konsultasi Publik 2</div>', 'Pengumuman/revisi-rencana-tata-ruang-wilayah-kota-rtrw-kota-samarinda.jpeg', 741, '2019-11-14 07:27:58', '2025-07-03 04:25:19'),
(4, 'Pengunguman Lelang Terbuka', 'pengunguman-lelang-terbuka', '<div>Dalam rangka lanjutan penertiban reklame atau baliho median jalan kota samarinda pada tahun anggaran 2022 sesuai dengan surat Wali Kota Samariinda nomor 600/1683/100.07 yang mana hasil dari bahan konstruksi dan kontan pembongkaran reklame hasil penetriban akan dilakukan pemusnahan dengan cara dilelang.</div><div>untuk informasi lebih lanjut dapat dilihat dari surat pengunguman terlampir</div><div>untuk pengiriman bisa diteruskan ke email instansi kami di&nbsp;</div><div>dpuprkotasamarinda@gmail.com</div>', 'Pengumuman/pengunguman-lelang-terbuka.pdf', 72, '2023-06-11 18:35:59', '2023-06-11 18:35:59');
...
(2, 'Peraturan Menteri Perdagangan Nomor 20/M-DAG/PER/4/2014 Tahun 2014 tentang Pengendalian dan Pengawasan Terhadap Pengadaan, Peredaran, dan Penjualan Minuman Beralkohol', 'peraturan-menteri-perdagangan-nomor-20m-dagper42014-tahun-2014-tentang-pengendalian-dan-pengawasan-terhadap-pengadaan-peredaran-dan-penjualan-minuman-beralkohol', 'Unduhan/2024-05/07/03634cc0-1240-11e9-9b81-ab5d1f7a283c/y4ZTAWG3IpgQCQgqCEbMvlH60LQRz6zivBAjhuqk.pdf', 7, 137, '2019-01-06 21:49:35', '2025-07-03 04:12:48'),
...
(9, 'Undang-undang (UU) Nomor 14 Tahun 2008 tentang Keterbukaan Informasi Publik', 'undang-undang-uu-nomor-14-tahun-2008-tentang-keterbukaan-informasi-publik', 'Unduhan/2024-05/07/16e9e4a0-d334-11e8-a08a-076338748d7d/psqM7cSgMmAjPSI0WedLtrGdI7q6t4tkHzE1RfCJ.pdf', 7, 142, '2018-10-18 16:15:31', '2025-07-03 04:12:57'),
...
(12, 'Peraturan Wali Kota Samarinda Nomor 26 Tahun 2024 Tentang Peraturan Pelaksanaan Peraturan Daerah Nomor 6 Tahun 2022 Tentang Penyelenggaraan Keterbukaan Informasi Publik', 'peraturan-wali-kota-samarinda-nomor-26-tahun-2024-tentang-peraturan-pelaksanaan-peraturan-daerah-nomor-6-tahun-2022-tentang-penyelenggaraan-keterbukaan-informasi-publik', 'Unduhan/2024-11/26/rkPXfmgVw5KyZjoIXwRNSPSJ4iVqlYW4bsCsmSFF.pdf', 7, 2, '2024-11-25 14:40:09', '2025-07-02 02:15:18'),
...
(51, 'Peraturan Wali Kota Samarinda Nomor 106 Tahun 2021 Tentang Kedudukan, Susunan Organisasi, Tugas dan Fungsi, Serta Tata Kerja Dinas Pekerjaan Umum dan Penataan Ruang Kota Samarinda', 'peraturan-wali-kota-samarinda-nomor-106-tahun-2021-tentang-kedudukan-susunan-organisasi-tugas-dan-fungsi-serta-tata-kerja-dinas-pekerjaan-umum-dan-penataan-ruang-kota-samarinda', 'Unduhan/2024-05/07/233fux6kkDKsEq8vpHQ3actzYvNjeLiVgKeDvy70.pdf', 7, 1, '2024-05-06 11:44:49', '2025-07-02 02:15:26'),
...
(1, '<div>Kantor Dinas Pekerjaan Umum dan Penataan Ruang Kota Samarinda beralamat di Jalan H. Achmad Amins, Kelurahan Gunung Lingai, Kecamatan Sungai Pinang, Kota Samarinda. Dinas Pekerjaan Umum dan Penataan Ruang Kota Samarinda semula berada di Komplek Balaikota Samarinda yang terletak di Jl. Kesuma Bangsa No.84, Kel. Bugis, Kec. Samarinda Kota, Kota Samarinda yang sekarang digunakan sebagai Kantor Diskominfo Kota Samarinda. Pada tahun 2018, Kantor Dinas Pekerjaan Umum dan Penataan Ruang Kota Samarinda dipindah ketempat yang sekarang.<br><br></div><div>Selanjutnya, pada tahun 2016 terbitlah Peraturan Daerah (PERDA) Kota Samarinda Nomor 4 Tahun 2016 pada tanggal 16 Agustus 2016 Tentang Pembentukan dan Susunan Perangkat Daerah yang dimana Dinas Pekerjaan Umum dan Penataan Ruang termasuk salah satu OPD dengan tipe A. Kemudian, pada tanggal 20 Oktober 2016 terbitlah Peraturan Walikota (PERWALI) Kota Samarinda Nomor 25 tahun 2016 Tentang Susunan Organisasi dan Tata Kerja Dinas Pekerjaan Umum dan Penataan Ruang Kota Samarinda Kota Samarinda. Dan terbentuknya Dinas Pekerjaan Umum dan Penataan Ruang Kota Samarinda adalah gabungan dari 2 (dua) Dinas, yaitu (1) Dinas Bina Marga dan Pengairan dan (2) Dinas Cipta Karya dan Tata Kota.<br><br></div><div>Berdasarkan Peraturan Wali Kota Samarinda Nomor 106 Tahun 2021 Tentang Kedudukan, Susunan Organisasi, Tugas dan Fungsi, Serta Tata Kerja Dinas Pekerjaan Umum dan Penataan Ruang Kota Samarinda pada tanggal 31 Desember 2021 yang susunan organisasi Dinas terdiri atas a. Dinas, b. Sekretariat, c. Bidang Bina Marga, d. Bidang Sumber Daya Air, e. Bidang Cipta Karya, f. Bidang Penataan Ruang, g. Bidang Bina Konstruksi, h. Bidang Pertanahan, i. UPTD Pengelolaan Air Limbah Domestik, j. UPTD Pemeliharaan Jalan dan Jembatan, k. Pemeliharaan Saluran Drainase dan Irigasi.</div>', '2024-07-23 19:52:53', '2025-07-03 03:41:17');
...
('7y1u15riFi45QwSyfBO6XKSbNp9dQdvq3YsHhe1L', 1, '127.0.0.1', 'Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Mobile Safari/537.36', '', 1751866170);
...
(2, 'Jembatan Mahakam', 'Slider/2.jpg', 1, 1, '2024-07-23 19:52:52', '2025-07-06 20:58:51'),
(3, 'Pembuka', 'Slider/3.png', 2, 1, '2024-07-23 19:52:52', '2025-07-06 20:58:51'),
(4, 'Penutup', 'Slider/4.png', 4, 1, '2024-12-26 08:39:45', '2024-12-26 01:02:17'),
(17, 'teest', 'Slider/teest-5.jpeg', 5, 1, '2025-07-06 20:27:48', '2025-07-06 20:27:48');
...
(1, 2, 'struktur-organisasi/sekretariat/ikon/sekretariat.png', 1, '2024-07-25 17:18:15', '2024-07-25 17:18:15'),
(2, 6, 'struktur-organisasi/bidang-sumber-daya-air/ikon/bidang-sumber-daya-air.png', 2, '2024-07-25 17:18:15', '2024-07-25 17:18:15'),
(3, 7, 'struktur-organisasi/bidang-bina-marga/ikon/bidang-bina-marga.png', 3, '2024-07-25 17:18:15', '2024-07-25 17:18:15'),
...
CREATE TABLE `susunan_organisasi` (
  `id_susunan_organisasi` bigint(20) UNSIGNED NOT NULL,
  `nama_susunan_organisasi` varchar(255) NOT NULL,
  `id_susunan_organisasi_parent` bigint(20) UNSIGNED DEFAULT NULL,
  `slug_susunan_organisasi` varchar(255) NOT NULL,
  `tupoksi_susunan_organisasi` text DEFAULT NULL,
  `deskripsi_susunan_organisasi` text DEFAULT NULL,
  `kelompok_susunan_organisasi` enum('UPTD','Bidang','Kepala Dinas','Sekretariat') NOT NULL,
  `is_subbagian` tinyint(1) NOT NULL DEFAULT 0,
  `is_susunan_organisasi_fungsional` tinyint(1) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `susunan_organisasi` (`id_susunan_organisasi`, `nama_susunan_organisasi`, `id_susunan_organisasi_parent`, `slug_susunan_organisasi`, `tupoksi_susunan_organisasi`, `deskripsi_susunan_organisasi`, `kelompok_susunan_organisasi`, `is_subbagian`, `is_susunan_organisasi_fungsional`, `created_at`, `updated_at`) VALUES
(0, 'Tenaga Informasi dan Teknologi', NULL, 'tenaga-informasi-dan-teknologi', NULL, NULL, '', 0, 0, '2025-07-05 10:05:05', '2025-07-05 10:05:05'),
...
(3, 'Subbagian Program', 2, 'subbagian-program', NULL, NULL, 'Sekretariat', 1, 0, '2024-07-23 19:52:49', '2025-06-29 06:13:55'),
...
(11, 'Bidang Pertanahan', 1, 'bidang-pertanahan', NULL, 'Melaksanakan koordinasi izin lokasi, redistribusi tanah, pengadaan tanah kosong, ganti rugi tanah, dan perencanaan pengunaan tanah', 'Bidang', 0, 0, '2024-07-23 19:52:49', '2025-07-04 02:39:54'),
...
INSERT INTO `users` (`id`, `id_susunan_organisasi`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 0, '8ifarrel', '8ifarrel@gmail.com', NULL, '$2y$12$7bNfmJo62gOsQP.VKOTgAuDTbysSuiEix2w8RfFL0Vi7p3YSw.pQi', NULL, '2024-12-25 03:40:37', '2024-12-25 03:40:37'),
(2, 53, 'sekretariat_tes', 'sekretariat@example.com', NULL, '$2y$12$lQrdDK1xDvVdaJS58nyJRex.5donj.NdQFqpETRtEo02plYL1W.kS', NULL, '2025-01-11 16:33:46', '2025-01-11 16:33:46'),
(4, 54, 'subbagian_tes', 'subbagian@example.com', NULL, '$2y$12$6zFNxuOYRpwz.5G/VKOQ.ut7YtRLKdOxnK3p0Rmh/6dBmBKicqQp6', NULL, '2025-01-11 16:38:53', '2025-01-11 16:38:53'),
(5, 1, 'desy_damayanti', 'desy_damayanti@example.com', NULL, '$2y$12$m3XG.4uFoeGiuE.fPSCe..f4KZD4r6oY6C835WnrXJY7HHYAnrQiq', NULL, NULL, NULL),
(6, 55, 'tes_subbagian_program', 'tes_subbagian_program@example.com', NULL, '$2y$12$nZ/mewp.JjB4b5TulKFZEuuh/mJ9cmX6fusUBI2j3c/oAAjHGkLEW', NULL, '2025-01-15 05:14:29', '2025-01-15 05:14:29'),
(7, 58, '234234', '23423@example.com', NULL, '$2y$12$asLjcyBw2/RdaXrm3KlkE.x0x6.HdZXh5iSr77R7/E/M9.F3MV6ji', NULL, '2025-01-15 01:11:39', '2025-01-15 01:11:39'),
(8, 59, '345345', '45335@example.com', NULL, '$2y$12$x5hPrOLHM565enCDHCDu.e9w9mRVQEdzAuRuFKEJIbc0NpZMJOW8m', NULL, '2025-01-15 01:14:16', '2025-01-15 01:14:16'),
(9, 60, 'sdsdsd', 'sdsdsdsds@example.com', NULL, '$2y$12$Zls7xMUSi38CJzNObLHam.RqO33k6AB1qizFwS57iNxT.hL48OeZS', NULL, '2025-01-15 23:00:19', '2025-01-15 23:00:19'),
(10, 61, '24234234', '2342342@example.com', NULL, '$2y$12$nDCzCRnEip24AiHEcYPTKOyz/hK2jzoyR0xeCkUlwSRbMbLPMUSem', NULL, '2025-01-15 23:04:09', '2025-01-15 23:04:09'),
(11, 62, '78978978', '978879@example.com', NULL, '$2y$12$AYGoSoPoQ/8vIQNqitl.c.n6pR0lD4AId0Rrp3FB.eQwnJZ/K1uJi', NULL, '2025-01-15 23:05:56', '2025-01-15 23:05:56'),
(12, 63, '687678', '686787@example.com', NULL, '$2y$12$9NH07xmOYq8asTBHb0F75O0VEY.wTUKkwE0Srw0NPoA4nz81AYa7e', NULL, '2025-01-15 23:09:03', '2025-01-15 23:09:03'),
(13, 64, '3424324', '34234234@gmail.com', NULL, '$2y$12$bTAAi89KpAk8WtnDS2iYWOG/1K9w/Ls/qEdhelp8V0CT7uhR3g6Ja', NULL, '2025-01-15 23:10:57', '2025-01-15 23:10:57'),
(14, 65, '5675675756', '7675@example.com', NULL, '$2y$12$NyF2dhEcj6r8mWdULkkt7u4OG9el1dw8nF930R88hVt6.MlJv0GK6', NULL, '2025-01-15 23:15:00', '2025-01-15 23:15:00'),
(15, 66, '24323424', '43453@gmail.com', NULL, '$2y$12$cJ/DOzJbQIm4JIZd6Sk9S.iUUtetlGCw0bpUpmq5h3CdnHH.uqwwy', NULL, '2025-01-15 23:15:52', '2025-01-15 23:15:52'),
(16, 67, '5464564565', '465464@gmail.com', NULL, '$2y$12$QI5jKfIapIrvjdZmL6wVne2RKmBb.wqiaOyA4lty43PNgpjOSH80q', NULL, '2025-01-15 23:33:03', '2025-01-15 23:33:03'),
(17, 68, '645645645', '6546@gmail.com', NULL, '$2y$12$w2efSWvADQw3evc.XyFs1uHzA15jyl7FUxPptnIC.xTc/Lqym.sCu', NULL, '2025-01-15 23:37:05', '2025-01-15 23:37:05'),
(18, 69, '34234234', '32423423@example.com', NULL, '$2y$12$9pu5rJW7WkfGhaYv01ygauRSOs3nzWWeoW1usia00lE46MdvDJ922', NULL, '2025-01-15 23:37:42', '2025-01-15 23:37:42'),
(19, 70, '45676546573', '657u547654@gmail.com', NULL, '$2y$12$l43O1ObaprP/yN2.YA94TentK1j98vi2MOFwskH9.m8Av4m2RiOSe', NULL, '2025-01-15 23:40:13', '2025-01-15 23:40:13'),
(20, 71, '23423423', '4324@gmail.com', NULL, '$2y$12$PurtZa0/DqTqtfGqmSEmyewvceSUaDKreypJVDhhl3xBEiEP2j6G2', NULL, '2025-01-15 23:41:53', '2025-01-15 23:41:53'),
(21, 72, '345678765', '4567897@gmail.com', NULL, '$2y$12$4sbFVheYCUXHdvxXF6Hr4.F2FiBloF7ZimJjrp7X0FCZuX7F1LvE.', NULL, '2025-01-16 18:23:03', '2025-01-16 18:23:03'),
(22, 73, '67897654', '768654@gmail.com', NULL, '$2y$12$GLWGb3EppdvBKXghzvXZueBxWdkl2e67q3pjVa2OIdb75J55dA.s2', NULL, '2025-01-16 18:25:08', '2025-01-16 18:25:08'),
(23, 74, '35674354', '754654345@gmail.com', NULL, '$2y$12$N5hd44HcKvOBH773rSC0xOUmc/kwgJ5QvN8CndKlubmJU8vFyofPK', NULL, '2025-01-16 18:29:43', '2025-01-16 18:29:43'),
(24, 75, '456789654324', '5678543245@gmail.co', NULL, '$2y$12$hEwrDCPoleQssdQTFSlzN.nrxO1KZBAJkuXmWsJfvT3RKt03gQXvW', NULL, '2025-01-16 18:30:16', '2025-01-16 18:30:16'),
(25, 76, '234567432', '563@gmail.com', NULL, '$2y$12$.NOCqdbdlPBtsen6Zdo6L.FhtWzhZZGM2ZRdxKZ8qlNReSURxPfAu', NULL, '2025-01-16 18:33:23', '2025-01-16 18:33:23'),
(26, 77, '43535', '335@gmail.co', NULL, '$2y$12$bNcrsF/UnRSJxGOgbYigaeNfpYVP7EYj2Dp6EEfKYpppOHVhE/yYm', NULL, '2025-01-16 18:33:55', '2025-01-16 18:33:55');
...
ALTER TABLE `kepala_dinas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `kepala_dinas_id_susunan_organisasi_foreign` (`id_susunan_organisasi`);
...
ALTER TABLE `kepala_dinas_jenjang_karir`
  ...
  ADD KEY `kepala_dinas_jenjang_karir_id_kepala_dinas_foreign` (`id_kepala_dinas`);
...
ALTER TABLE `kepala_dinas_riwayat_pendidikan`
  ...
  ADD KEY `kepala_dinas_riwayat_pendidikan_id_kepala_dinas_foreign` (`id_kepala_dinas`);
...
ALTER TABLE `susunan_organisasi`
  ...
  ADD UNIQUE KEY `susunan_organisasi_nama_susunan_organisasi_unique` (`nama_susunan_organisasi`),
  ADD UNIQUE KEY `susunan_organisasi_slug_susunan_organisasi_unique` (`slug_susunan_organisasi`),
  ADD KEY `jabatan_id_jabatan_parent_foreign` (`id_susunan_organisasi_parent`),
  ADD KEY `susunan_organisasi_id_susunan_organisasi_parent_foreign` (`id_susunan_organisasi_parent`);
...
--
ALTER TABLE `kepala_dinas_jenjang_karir`
  MODIFY `id_karir` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=310;

--
-- AUTO_INCREMENT untuk tabel `kepala_dinas_riwayat_pendidikan`
--
ALTER TABLE `kepala_dinas_riwayat_pendidikan`
  MODIFY `id_pendidikan` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=235;
...
--
ALTER TABLE `partner`
  MODIFY `id_partner` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `slider`
  MODIFY `id_slider` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT untuk tabel `struktur_organisasi`
--
ALTER TABLE `struktur_organisasi`
  MODIFY `id_struktur_organisasi` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT untuk tabel `struktur_organisasi_diagram`
--
ALTER TABLE `struktur_organisasi_diagram`
  MODIFY `id_struktur_organisasi_diagram` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT untuk tabel `struktur_organisasi_slider`
--
ALTER TABLE `struktur_organisasi_slider`
  MODIFY `id_slider` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT untuk tabel `susunan_organisasi`
--
ALTER TABLE `susunan_organisasi`
  MODIFY `id_susunan_organisasi` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
...
--
-- Ketidakleluasaan untuk tabel `kepala_dinas`
--
ALTER TABLE `kepala_dinas`
  ADD CONSTRAINT `kepala_dinas_id_susunan_organisasi_foreign` FOREIGN KEY (`id_susunan_organisasi`) REFERENCES `susunan_organisasi` (`id_susunan_organisasi`) ON DELETE SET NULL;

--
-- Ketidakleluasaan untuk tabel `kepala_dinas_jenjang_karir`
--
ALTER TABLE `kepala_dinas_jenjang_karir`
  ADD CONSTRAINT `kepala_dinas_jenjang_karir_id_kepala_dinas_foreign` FOREIGN KEY (`id_kepala_dinas`) REFERENCES `kepala_dinas` (`id`) ON DELETE SET NULL,
...
--
ALTER TABLE `kepala_dinas_riwayat_pendidikan`
  ADD CONSTRAINT `kepala_dinas_riwayat_pendidikan_id_kepala_dinas_foreign` FOREIGN KEY (`id_kepala_dinas`) REFERENCES `kepala_dinas` (`id`) ON DELETE SET NULL,
...
--
ALTER TABLE `susunan_organisasi`
  ADD CONSTRAINT `susunan_organisasi_id_susunan_organisasi_parent_foreign` FOREIGN KEY (`id_susunan_organisasi_parent`) REFERENCES `susunan_organisasi` (`id_susunan_organisasi`) ON DELETE CASCADE;
COMMIT;
