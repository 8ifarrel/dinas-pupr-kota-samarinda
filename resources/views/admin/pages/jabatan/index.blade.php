                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  <div class="p-4 md:p-5 space-y-4">
                    <p class="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                      Apakah Anda yakin ingin menghapus jabatan <strong>{{ $item->nama_jabatan }}</strong>? Anda secara otomatis akan juga menghapus pegawai, subbagian, dan jabatan fungsional yang ada pada {{ $item->nama_jabatan }}
                    </p>
                  </div>
                  <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
...
>>>>>>> c9eca50 (Pegawai sisa CREATE yang belum selesai)
            @endif
          @endforeach
        </tbody>
        <tfoot>
