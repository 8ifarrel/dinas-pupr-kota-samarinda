...
@section('slot')
  <form action="{{ route('admin.berita.kategori.update', $kategori->id_berita_kategori) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="mb-4">
      ...
      <span class="text-xs text-gray-700">Anda harus menggantinya melalui nama jabatan</span>
      <input type="text" name="nama_kategori" id="nama_kategori" value="{{ $kategori->jabatan->nama_jabatan }}"
    ...
    <div class="mb-4 relative">
      ...
      <span class="text-xs text-gray-700">Kosongi bagian ini jika tetap ingin menggunakan ikon sebelumnya</span>
      <input type="file" name="ikon_berita_kategori" id="ikon_berita_kategori" class="mt-1" />
...
@section('js')
    @vite('resources/js/admin/berita_kategori.js')
@endsection
