...
@section('slot')
  <form action="{{ route('admin.struktur-organisasi.organigram.update', 1) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="mb-4 relative">
      <input type="file" name="foto_organigram" id="foto_organigram" />
    ...
    <img
      ...
      alt="Organigram" id="current-organigram-img" class="hidden" />
