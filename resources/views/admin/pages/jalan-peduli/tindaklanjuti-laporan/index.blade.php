    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 2xl:grid-cols-3 gap-8">
      @foreach ($laporans as $laporan)
          ...
          <div class="px-5 pb-5 mt-auto">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <a href="{{ route('admin.jalan-peduli.tindaklanjuti-laporan.edit', $laporan->id_laporan) }}" 
                class="btn-hover bg-yellow-500 text-white font-bold px-4 py-2 w-full rounded-lg hover:bg-yellow-600 flex items-center justify-center gap-2 text-sm">
              ...
              <a href="{{ route('admin.jalan-peduli.laporan-masuk.show', $laporan->id_laporan) }}"
                class="btn-hover bg-blue-700 text-white font-bold px-4 py-2 w-full rounded-lg hover:bg-blue-800 flex items-center justify-center gap-2 text-sm">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <button data-modal-target="deleteModal-{{ $laporan->id_laporan }}"
          ...
          class="btn-hover bg-red-600 text-white font-bold px-4 py-2 w-full rounded-lg hover:bg-red-700 flex items-center justify-center gap-2 text-sm">
                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
              ...
              @if($statusNama === 'telah_dikerjakan')
                ...
                <a href="#" 
                  ...
                  class="btn-hover bg-green-600 text-white font-bold px-4 py-2 rounded-lg hover:bg-green-700 flex items-center justify-center gap-2 text-sm w-full sm:col-span-3">
