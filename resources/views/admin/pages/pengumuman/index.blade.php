      ...
      <table id="pengumuman" class="stripe hover row-border table-auto" style="width:100%">
        ...
        <tbody>
          @foreach ($pengumuman as $item)
            <tr>
              ...
              <td>
                <button type="button"
                  ...
                  data-modal-toggle="contentModal-{{ $item->id }}">
            ...
            <x-admin.modal-hapus :id="$item->id" :aksi="route('admin.pengumuman.destroy', $item->id)">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
            ...
            <button type="button"
              ...
              data-modal-hide="contentModal-{{ $item->id }}">
          ...
          <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button type="button"
              ...
              data-modal-hide="contentModal-{{ $item->id }}">Tutup</button>
          </div>
        </div>
      </div>
    </div>
