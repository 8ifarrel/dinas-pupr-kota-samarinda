            ...
            <tr>
              ...
              <td>
                @if ($foto->caption)
                  ...
                  <!-- Modal Caption -->
                  <div id="captionModal-{{ $foto->id }}" data-modal-target="captionModal-{{ $foto->id }}"
              ...
              <td>
                <div class="flex gap-2">
                  ...
                  <button type="button"
                    ...
                    title="Hapus" data-modal-target="deleteFotoModal-{{ $foto->id }}"
                    data-modal-toggle="deleteFotoModal-{{ $foto->id }}">
                    <i class="fa-solid fa-trash-can"></i>
                  </button>
                </div>
                <!-- Modal Hapus -->
                <div id="deleteFotoModal-{{ $foto->id }}" data-modal-target="deleteFotoModal-{{ $foto->id }}"
                  ...
                  <div class="relative p-4 max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                      ...
                      <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                        <form action="{{ route('admin.album-kegiatan.foto-kegiatan.destroy', [$album->id, $foto->id]) }}"
                          method="POST">
                          @csrf
                          @method('DELETE')
                          <button type="submit"
