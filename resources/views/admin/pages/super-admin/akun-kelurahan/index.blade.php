...
@section('document.body')
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
    <a href="{{ route('admin.hantu-banyu.akun-kelurahan.create') }}"
    ...
    <form method="GET" action="{{ route('admin.hantu-banyu.akun-kelurahan.index') }}" class="flex items-center gap-2">
            ...
            <tr>
              ...
              <td>
                <div class="flex gap-2">
                  <a href="{{ route('admin.hantu-banyu.akun-kelurahan.edit', $item->id) }}"
              ...
              <div class="relative p-4 w-full max-w-2xl max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    <form action="{{ route('admin.hantu-banyu.akun-kelurahan.destroy', $item->id) }}" method="POST">
                      @csrf
                      @method('DELETE')
                      <button type="submit"
