...
@section('document.body')
  ...
  <a href="{{ route('admin.super.api-key.hantu-banyu.create') }}"
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      apiKeysTable = $('#api-key').DataTable({
        ajax: {
          url: '{{ route("api.hantu-banyu-keys.index") }}',
          type: 'GET',
          dataSrc: 'data',
    ...
    function confirmRegenerate() {
      $.ajax({
        url: `/api/hantu-banyu-keys/${currentApiKeyId}/regenerate`,
        type: 'POST',
        headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
    ...
    function confirmDelete() {
      $.ajax({
        url: `/api/hantu-banyu-keys/${currentApiKeyId}`,
        type: 'DELETE',
        headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
