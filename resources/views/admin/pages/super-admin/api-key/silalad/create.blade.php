...
@section('document.body')
  <div class="bg-white rounded-lg shadow p-6">
    <div class="mb-6">
      <h2 class="text-2xl font-bold">Buat API Key SILALAD</h2>
      <p class="text-gray-600 mt-2">Buat API key baru untuk mengakses API SILALAD.</p>
    </div>
...
@section('document.end')
  <script>
    ...
    function goToIndex() {
      window.location.href = '{{ route("admin.super.api-key.silalad.index") }}';
    }
