<footer class="bg-[#D9D9D9D9] flex flex-col items-center">
    <div class="xs:grid xs:grid-cols-2 md:grid-cols-[auto_auto_300px] lg:grid-cols-[auto_auto_350px] lg:w-[930px] xl:w-auto lg:auto-cols-auto xl:flex xl:justify-between p-[1.35rem] md:p-8 lg:py-8 lg:px-0 xl:p-12 xl:h-[360px]">
        <figure class="xs:col-span-2 md:col-span-3 mb-4 xl:mb-0 xl:w-[35%]">
            <span class="flex gap-2 mb-1 xl:mb-2">
                <img class="h-[50px] xl:h-[75px]" src="{{ asset('image/logo/pemkot-samarinda.png') }}" alt="Pemerintah Kota Samarinda" />
            ...
            <figcaption>
                    Jalan H. Achmad Amins, Kelurahan Gn. Lingai, Kecamatan Sungai Pinang, Kota Samarinda, Provinsi Kalimantan Timur, 75117
            </figcaption>
        </figure>
        ...
        <ul class="xs:mx-auto sm:mx-0 mb-3 lg:mb-0 xl:mb-0 text-base xl:text-lg p-0 m-0 flex flex-col justify-between w-fit">
            <li class="mb-1 xs:mb-0 font-bold text-lg xl:text-xl">
                KONTAK KAMI
            </li>
            <li>
            ...
            <li>
				<i class="fa-brands fa-whatsapp me-1" style="color: #000000;"></i>
                WhatsApp
            </li>
            <li>
        ...
        <div>
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.690298112536!2d117.17512067507042!3d-0.45899179953650165!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df5d6033b793f91%3A0xe380dade32764edd!2sKantor%20PUPR%20Samarinda!5e0!3m2!1sen!2sid!4v1704714282337!5m2!1sen!2sid" class="h-[193.517px] w-[250px] xs:w-[300px] lg:w-[350px]" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
