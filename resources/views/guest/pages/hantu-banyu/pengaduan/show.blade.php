      ...
      <ol class="hidden md:inline-flex items-center text-sm">
        ...
        <li>
          <div class="flex items-center">
            ...
            <a href="{{ route('guest.hantu-banyu.index') }}" class="text-blue-600 underline">Hantu Banyu
            </a>
          </div>
        </li>
        <li>
          <div class="flex items-center">
            ...
            <a href="{{ route('guest.hantu-banyu.pengaduan.index') }}" class="text-blue-600 underline">
      ...
      <div class="md:hidden mt-1">
        <div id="breadcrumb-dropdown"
          ...
          <ol class="py-2 text-sm text-gray-700">
            ...
            <li>
              <a href="{{ route('guest.hantu-banyu.index') }}" class="block px-4 py-2 hover:bg-gray-100">Hantu Banyu</a>
            </li>
            <li>
              <a href="{{ route('guest.hantu-banyu.pengaduan.index') }}"
