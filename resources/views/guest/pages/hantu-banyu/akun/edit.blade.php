...
@section('document.body')
  <div class="max-w-xl mx-auto px-4 py-10 md:py-14">
    <nav class="mb-4 text-sm">
      <a href="{{ route('guest.hantu-banyu.index') }}" class="text-blue-600 hover:underline">
    ...
    <div class="bg-white rounded-xl shadow-lg border p-6 sm:p-8">
      <form method="POST" action="{{ route('guest.hantu-banyu.akun.update') }}" class="space-y-5">
        @csrf
        @method('PUT')
        ...
        <div class="pt-1 flex items-center gap-3">
          ...
          <a href="{{ route('guest.hantu-banyu.index') }}" class="text-sm font-medium text-gray-600 hover:text-gray-800">
            Batal
          </a>
        </div>
      </form>
