...
@section('slot')
        ...
        <tbody>
          @foreach ($pengumuman as $item)
            <tr>
              ...
              {{-- Lampiran --}}
              <td>
                <button data-modal-target="static-modal-{{ $loop->index }}" data-modal-toggle="static-modal-{{ $loop->index }}"
  ...
  @foreach ($pengumuman as $item)
    <!-- Main modal -->
    <div id="static-modal-{{ $loop->index }}" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
      ...
      <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button data-modal-hide="static-modal-{{ $loop->index }}" type="button"
