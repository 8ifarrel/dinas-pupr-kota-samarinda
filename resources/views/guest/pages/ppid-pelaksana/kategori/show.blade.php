...
@section('slot')
  <div class="py-5 md:py-12 px-6 lg:px-24 3xl:px-48">
    <div class="text-center mb-2 lg:mb-3">
      <span class="bg-blue uppercase font-bold text-yellow text-sm lg:text-base me-2 px-4 py-1 rounded-full dark:bg-blue-900 dark:text-blue-300">
        PPID Pelaksana
      </span>
    </div>

    <h1 class="text-center font-bold text-2xl lg:text-3xl pb-6 lg:pb-12 uppercase">
      {{ $ppid_pelaksana_kategori->nama }}
    </h1>
      ...
      <table id="ppid-pelaksana" class="border shadow border-separate rounded-3xl stripe hover row-border table-auto w-full">
        <thead>
          <tr>
            ...
            <th class="bg-yellow/35">Nama</th>
            <th class="bg-yellow/35">Waktu Terbit</th>
            <th class="bg-yellow/35">Terakhir Diperbarui</th>
            <th class="bg-yellow/35">Telah Diunduh</th>
            <th class="bg-yellow/35 border-none rounded-tr-3xl">Aksi</th>
          </tr>
        </thead>
        <tbody>
              ...
              <td>
                @if ($item->file)
                  <button
                    ...
                    class="block text-white text-nowrap bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 bg-blue font-semibold rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
