    ...
    <div class="max-w-4xl mx-auto space-y-5">
      ...
      <div class="bg-white rounded-lg shadow-lg border p-6 space-y-5">
            ...
            @foreach ($riwayat as $jejak)
              @php
                $titik = match ($jejak->status) {
                    'Menunggu konfirmasi' => 'bg-yellow-400',
                    'Dijadwalkan' => 'bg-indigo-500',
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          {{-- Detail Lokasi --}}
          <div>
            <h4 class="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-2">Detail Lokasi &amp; Waktu</h4>
            <dl class="text-sm divide-y border rounded-lg">
              <div class="flex justify-between gap-3 px-3 py-2">
              ...
              <div class="flex justify-between gap-3 px-3 py-2">
                <dt class="text-gray-500">Tanggal Pengerjaan</dt>
                <dd class="text-right">
                  {{ $data->tanggal_diharapkan ? $data->tanggal_diharapkan->translatedFormat('d F Y') : '-' }}
                </dd>
              </div>
              <div class="flex justify-between gap-3 px-3 py-2">
