...
@section('content')
    <div class="max-w-4xl mx-auto mt-8">
        <form id="mapFilterForm" method="GET" class="glass-effect rounded-2xl p-6 shadow-lg">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-end">
                ...
                <div class="md:col-span-1">
                    <button type="submit" class="bg-brand-blue hover:bg-brand-blue/90 text-white font-semibold px-6 py-3 rounded-xl w-full transition-all duration-300 flex items-center justify-center gap-2">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                @foreach([
                    ...
                    <div class="glass-effect rounded-xl p-4 text-center">
                        <div class="bg-gray-100/80 rounded-lg p-2 mb-3 inline-block">
    ...
    <div class="max-w-7xl mx-auto mt-12 bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="p-6 bg-brand-blue/5 rounded-b-2xl">
