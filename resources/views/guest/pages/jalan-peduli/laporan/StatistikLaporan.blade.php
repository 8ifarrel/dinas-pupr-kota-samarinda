...
@section('content')
                    ...
                    <div
                        ...
                        <div id="filterRadioGroup" class="flex items-center p-1 bg-slate-200 rounded-full w-full lg:w-auto">
                            <label data-value="bulan"
                                ...
                                <input type="radio" name="filter" value="bulan" class="sr-only"
                                    checked><span>Bulan</span>
                            </label>
    ...
    {{-- Konten utama --}}
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 pt-4 sm:pt-6 lg:pt-8 pb-4 sm:pb-6 lg:pb-8">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateCharts(data) {
                ...
                laporanMasukChart = renderChart('laporanMasukChart', ['Pending', 'Accept'], laporanMasukData, [
                    '#9ca3af',
                    '#10b981'
                ]);
                ...
                laporanDetailChart = renderChart('laporanChart', ['Belum Dikerjakan', 'Sedang Dikerjakan',
                    'Telah di Survei',
                ...
                const jenisKerusakanColors = ['#FF6384', '#36A2EB', '#FFCE56', '#8B5CF6', '#F59E42', '#10B981',
                    '#F43F5E',
                    '#6366F1'
                ];
                if (jenisKerusakanChart) jenisKerusakanChart.destroy();
                jenisKerusakanChart = renderChart('jenisKerusakanChart', jenisKerusakanLabels,
                    jenisKerusakanDataArr,
                ...
                tingkatKerusakanChart = renderChart('tingkatKerusakanChart', tingkatKerusakanLabels,
                    tingkatKerusakanDataArr,
