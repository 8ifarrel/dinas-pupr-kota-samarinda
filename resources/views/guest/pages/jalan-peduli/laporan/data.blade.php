...
@section('content')
  <div class="min-h-screen bg-gray-50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
              <div class="md:col-span-12 lg:col-span-7">
                ...
                <div class="relative group">
                  ...
                  <input type="text" id="search" name="search"
                    ...
                    placeholder="e.g., LPRN-12345, Jl. Merdeka" value="{{ request('search') }}" autocomplete="off">
                </div>
              </div>
              ...
              <div class="md:col-span-6 lg:col-span-3">
                ...
                <select name="status_filter" id="status_filter"
                  ...
                  <option value="belum_dikerjakan" {{ request('status_filter') == 'belum_dikerjakan' ? 'selected' : '' }}>
                    Belum Dikerjakan</option>
                  <option value="sedang_dikerjakan"
                    {{ request('status_filter') == 'sedang_dikerjakan' ? 'selected' : '' }}>Sedang Dikerjakan</option>
                  <option value="telah_dikerjakan" {{ request('status_filter') == 'telah_dikerjakan' ? 'selected' : '' }}>
                    Telah Dikerjakan</option>
                  <option value="telah_disurvei" {{ request('status_filter') == 'telah_disurvei' ? 'selected' : '' }}>
                    Telah Disurvei</option>
                  <option value="disposisi" {{ request('status_filter') == 'disposisi' ? 'selected' : '' }}>Disposisi
                  </option>
                </select>
              </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      @if (session('success'))
        <div
          class="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 text-green-800 p-5 mb-8 rounded-xl shadow-lg fade-in"
          role="alert">
      ...
      @if (session('error'))
        <div
          class="bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 text-red-800 p-5 mb-8 rounded-xl shadow-lg fade-in"
          role="alert">
          <div class="flex items-center">
                  ...
                  <div class="flex flex-col lg:flex-row items-center lg:items-start gap-8">
                    ...
                    <div class="flex-grow text-center lg:text-left">
                      ...
                      <p
                        ...
                        Terima kasih! Laporan Anda sedang dalam proses verifikasi oleh tim kami. Ini biasanya memakan
                        waktu 1-2 hari kerja. Status akan diperbarui setelah verifikasi selesai.
                      </p>
                      <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                        <a href="{{ route('laporan.download', ['id_laporan' => $laporan->id_laporan]) }}"
                          target="_blank"
                    ...
                    <div class="p-6 sm:p-8">
                      <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
                        ...
                        <div class="xl:col-span-8">
                          ...
                          {{-- Deskripsi --}}
                          <div class="mb-8">
                            <h4 class="text-lg font-semibold text-gray-800 mb-3 flex items-center"><i
                                class="fas fa-file-alt text-blue-500 mr-3"></i>Deskripsi Laporan</h4>
                            @php
                              ...
                              <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
                                @foreach ($fotoArray as $index => $foto)
                                  <a href="{{ asset('storage/jalan_peduli/' . $laporan->id_laporan . '/' . $foto) }}"
                                    ...
                                    <img
                                      data-src="{{ asset('storage/jalan_peduli/' . $laporan->id_laporan . '/' . $foto) }}"
                          ...
                          @if ($laporan->latitude && $laporan->longitude)
                            <div class="mb-6">
                              <h4 class="text-lg font-semibold text-gray-800 mb-4 flex items-center"><i
                                  class="fas fa-map-marked-alt text-green-500 mr-3"></i>Lokasi pada Peta</h4>
                        ...
                        <div class="xl:col-span-4 xl:border-l xl:border-gray-200 xl:pl-8">
                          ...
                          <div class="space-y-4 mb-8">
                            <h4 class="text-base font-semibold text-gray-500 mb-3 text-center xl:text-left">DETAIL
                              LAPORAN</h4>
                            <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                              <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-gray-600 flex items-center"><i
                                    class="fas fa-exclamation-triangle text-orange-500 mr-2"></i>Tingkat Kerusakan</span>
                                <span
                            ...
                            <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                              <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-gray-600 flex items-center"><i
                                    class="fas fa-tools text-purple-500 mr-2"></i>Jenis Kerusakan</span>
                                <span
                          ...
                          @if ($laporan->keterangan)
                            <div class="mb-8">
                              <h4 class="text-base font-semibold text-gray-500 mb-3 text-center xl:text-left">CATATAN
                                PETUGAS</h4>
                              @php
                          ...
                          @if ($laporan->status && in_array($statusNama, $allowed_statuses) && !empty($laporan->foto_lanjutan))
                            ...
                            @endphp
                            <div class="mb-8">
                              <h4 class="text-base font-semibold text-gray-500 mb-4 text-center xl:text-left">DOKUMENTASI
