...
@section('styles')
    ...
    <style>
        ...
        .pulse-soft {
            animation: pulseSoft 2.5s infinite cubic-bezier(0.4, 0, 0.6, 1);
        }
        ...
        .collapse-container.open {
            max-height: 2000px;
            /* Adjust based on content size; large enough to cover most cases */
        }
...
@section('content')
    <div class="min-h-screen bg-gray-50">
            ...
            <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
                <div class="text-center mb-12">
                    ...
                    <p class="text-lg md:text-xl text-white/90 max-w-3xl mx-auto">
                        Pantau perkembangan laporan infrastruktur jalan yang telah Anda kirimkan dengan mudah dan
                        transparan.
                    </p>
                </div>
                            ...
                            <div class="md:col-span-12 lg:col-span-2">
                                ...
                                <select name="status_filter" id="status_filter"
                                    ...
                                    <option value="sedang_dikerjakan"
                                        {{ request('status_filter') == 'sedang_dikerjakan' ? 'selected' : '' }}>Sedang
                                        Dikerjakan</option>
                                    <option value="telah_dikerjakan"
                                        {{ request('status_filter') == 'telah_dikerjakan' ? 'selected' : '' }}>
                                        Telah Dikerjakan</option>
                                    <option value="telah_disurvei"
                                        {{ request('status_filter') == 'telah_disurvei' ? 'selected' : '' }}>
                                        Telah Disurvei</option>
                                    <option value="disposisi"
                                        {{ request('status_filter') == 'disposisi' ? 'selected' : '' }}>Disposisi
                                    </option>
                                </select>
                            </div>
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            @if (session('success'))
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 text-green-800 p-5 mb-8 rounded-xl shadow-lg fade-in"
                    role="alert">
            ...
            @if (session('error'))
                <div class="bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 text-red-800 p-5 mb-8 rounded-xl shadow-lg fade-in"
                    role="alert">
                    <div class="flex items-center">
            ...
            @if (isset($laporans))
                @if ($laporans->isEmpty())
                    ...
                    <div
                        class="bg-white border-2 border-dashed border-yellow-300 text-center p-12 mt-8 rounded-2xl shadow-lg fade-in">
                        <div class="max-w-md mx-auto">
                            ...
                            <p class="text-gray-600 mb-6 leading-relaxed">
                                ...
                                <span
                                    class="font-semibold text-gray-800 mt-2 inline-block px-3 py-1 bg-yellow-100 rounded-full">"{{ request('search') }}"</span>
                            </p>
                            <div class="bg-yellow-50 rounded-xl p-4 text-left">
                                <p class="text-sm text-yellow-800">
                                    <strong class="flex items-center mb-2"><i class="fas fa-lightbulb mr-2"></i>Tips
                                        Pencarian:</strong>
                ...
                @else
                        ...
                        <div class="bg-white rounded-xl shadow-md border border-gray-200 p-5">
                            <div class="flex flex-col sm:flex-row items-center justify-between">
                                <div class="flex items-center space-x-4">
                                    <div
                                        class="w-12 h-12 bg-brand-blue rounded-full flex items-center justify-center flex-shrink-0 border-2 border-primary-navy shadow">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-500">
                                            ...
                                            <strong>{{ $laporans->total() }}</strong> laporan ditemukan.
                                        </p>
                                    </div>
                                </div>
                                <div class="hidden sm:flex items-center space-x-2 text-sm text-gray-600 mt-4 sm:mt-0">
                                    <i class="fas fa-clock"></i>
                                    <span>Diperbarui {{ now()->locale('id')->isoFormat('DD MMMM YYYY, HH:mm') }}
                                        WITA</span>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach ($laporans as $laporan)
                        @php
                            ...
                            $statusNama = $laporan->status
                                ? strtolower($laporan->status->nama_status)
                                : 'tidak diketahui';
                        @endphp
                        ...
                        @if ($statusNama == 'pending')
                            <div
                                class="bg-white border-l-8 border-primary-navy rounded-2xl shadow-xl overflow-hidden mb-8 card-hover fade-in">
                                <div class="p-8">
                                    <div class="flex flex-col lg:flex-row items-center lg:items-start gap-8">
                                        <div class="flex-shrink-0">
                                            <div
                                                class="w-20 h-20 bg-primary-navy rounded-full flex items-center justify-center shadow-lg">
                                                <i
                                                    class="fas fa-hourglass-half text-3xl text-white pulse-soft animate-spin"></i>

                                            </div>
                                        </div>
                                        <div class="flex-grow text-center lg:text-left">
                                            <div
                                                class="flex flex-col-reverse lg:flex-row lg:items-center lg:justify-between mb-4">
                                                <div
                                                    class="flex items-center justify-center lg:justify-start space-x-2 text-sm text-gray-600 mt-2 lg:mt-0">
                                                    <i class="fas fa-hashtag"></i>
                                                    <span>ID Laporan: <strong
                                                            class="text-gray-800">{{ $laporan->id_laporan }}</strong></span>
                                                </div>
                                                <span
                                                    class="inline-flex items-center px-4 py-2 rounded-full text-sm font-semibold bg-primary-navy text-white shadow-md status-badge">
                                                    <i class="fas fa-hourglass-half mr-2 animate-spin"></i>
                                                    Menunggu Verifikasi
                                                </span>
                                            </div>
                                            <h3 class="text-2xl font-bold text-primary-navy mb-3">Laporan Sedang
                                                Diverifikasi</h3>
                                            <p
                                                class="text-gray-700 mb-6 leading-relaxed max-w-2xl bg-secondary-pale-blue rounded-xl px-4 py-3 mx-auto lg:mx-0">
                                                Terima kasih! Laporan Anda sedang dalam proses verifikasi oleh tim kami. Ini
                                                biasanya memakan
                                    ...
                                    <div
                                        ...
                                        <div class="flex-grow w-full">
                                            <div class="flex items-center mb-2 flex-wrap gap-2">
                                                <span
                                                    class="text-xs font-bold {{ $currentStatus['badge_bg'] }} px-2 py-1 rounded-full mr-3">{{ $laporan->id_laporan }}</span>
                                                <span
                                                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold {{ $currentStatus['badge_bg'] }}">
                                            ...
                                            <div x-show="!open" class="flex flex-col md:flex-row md:items-center w-full">
                                                <h3
                                                    class="text-xl font-bold text-gray-800 leading-tight mr-4 mb-2 md:mb-0">
                                                    {{ $laporan->alamat_lengkap_kerusakan }}
                                                </h3>
                                                <div
                                                    class="flex flex-col md:flex-row md:items-center flex-wrap gap-2 md:gap-4">
                                                    <p class="text-sm text-gray-500 flex items-center">
                                                        <i class="fas fa-calendar-alt mr-1"></i>
                                                        {{ \Carbon\Carbon::parse($laporan->created_at)->isoFormat('DD MMMM YYYY') }}
                                                    </p>
                                                    <span
                                                        class="flex items-center text-sm text-gray-500 truncate max-w-[180px] sm:max-w-[220px] md:max-w-none">
                                                        <i class="fas fa-city mr-1"></i>
                                                        {{ $laporan->rt }}, {{ $laporan->kelurahan->nama ?? 'N/A' }},
                                                        {{ $laporan->kecamatan->nama ?? 'N/A' }}
                                                    </span>
                                                    <span
                                                        class="flex items-center text-sm text-gray-500 truncate max-w-[150px] sm:max-w-[180px] md:max-w-none">
                                        ...
                                        <div class="flex-shrink-0 flex items-center gap-4 w-full sm:w-auto mt-4 sm:mt-0">
                                            <a href="{{ route('laporan.download.public', ['id_laporan' => $laporan->id_laporan]) }}"
                                                target="_blank" @click.stop
                                                class="w-full sm:w-auto inline-flex items-center justify-center px-5 py-2.5 border border-transparent text-sm font-semibold rounded-lg shadow-lg text-white bg-primary-navy hover:bg-primary-yellow hover:text-primary-navy transform hover:scale-105 transition-transform duration-300">
                                                <i class="fas fa-download mr-2"></i>
                                                Unduh Bukti Laporan
                                            </a>
                                            <button
                                                class="w-full sm:w-auto inline-flex items-center justify-center px-5 py-2.5 border-2 border-gray-300 text-sm font-semibold rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition-colors duration-200">
                                            ...
                                            <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
                                                ...
                                                <div class="xl:col-span-8">
                                                    ...
                                                    <div class="mb-8">
                                                        <h4
                                                            ...
                                                            <i class="fas fa-map-signs text-gray-500 mr-3"></i>Lokasi
                                                            Detail
                                                        </h4>
                                                        <p class="text-gray-600 flex items-center">
                                                            <i class="fas fa-city mr-2 text-gray-400"></i>
                                                            Kel. {{ $laporan->kelurahan->nama ?? 'N/A' }}, Kec.
                                                            {{ $laporan->kecamatan->nama ?? 'N/A' }}
                                                        </p>
                                                    </div>
                                                    ...
                                                    <div class="mb-8">
                                                        ...
                                                        @php
                                                            ...
                                                            $shortDescription = $isLongDescription
                                                                ? substr($deskripsi, 0, $limit) . '...'
                                                                : $deskripsi;
                                                        @endphp
                                                        <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                                            <div
                                                                class="text-gray-700 leading-relaxed space-y-2 break-words">
                                                                <p x-show="!showFullDescription">{{ $shortDescription }}
                                                                </p>
                                                                <p x-show="showFullDescription" x-collapse>
                                                                    {{ $deskripsi }}</p>
                                                            </div>
                                                            @if ($isLongDescription)
                                                                <button @click="showFullDescription = !showFullDescription"
                                                                    class="text-sm font-semibold text-blue-600 hover:text-blue-800 hover:underline mt-3">
                                                                    <span
                                                                        x-text="showFullDescription ? 'Tutup' : 'Baca Selengkapnya'"></span>
                                                                </button>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    @if ($laporan->dokumen_pendukung)
                                                        <div class="mb-8">
                                                            <h4
                                                                class="text-lg font-semibold text-gray-800 mb-3 flex items-center">
                                                                <i class="fas fa-file-pdf text-red-500 mr-3"></i>Dokumen
                                                                Pendukung
                                                            </h4>
                                                            <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                                                <div class="flex items-center">
                                                                    <i
                                                                        class="fas fa-file-pdf text-red-500 text-3xl mr-4"></i>
                                                                    <div>
                                                                        <p class="text-sm text-gray-600 mb-1">Dokumen
                                                                            Pendukung Laporan</p>
                                                                        <a href="{{ asset('storage/jalan_peduli/' . $laporan->id_laporan . '/' . $laporan->dokumen_pendukung) }}"
                                                                            ...
                                                                            <i class="fas fa-download mr-2"></i> Lihat
                                                                            Dokumen
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    @if (!empty($fotoArray))
                                                        <div class="mb-8">
                                                            <h4
                                                                ...
                                                                <i
                                                                    class="fas fa-camera text-purple-500 mr-3"></i>Dokumentasi
                                                                Kerusakan
                                                            ...
                                                            <div
                                                                ...
                                                                @foreach ($fotoArray as $index => $foto)
                                                                    <a href="{{ asset('storage/jalan_peduli/' . $laporan->id_laporan . '/' . $foto) }}"
                                                                        ...
                                                                        <img data-src="{{ asset('storage/jalan_peduli/' . $laporan->id_laporan . '/' . $foto) }}"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <i
                                                                                class="fas fa-expand text-white text-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 transform group-hover:scale-125"></i>
                                                                        </div>
                                                                    </a>
                                                                @endforeach
                                                            </div>
                                                    ...
                                                    @if ($laporan->latitude && $laporan->longitude)
                                                        <div class="mb-6">
                                                            ...
                                                            <div
                                                                ...
                                                                <iframe
                                                                    data-src="https://maps.google.com/maps?q={{ $laporan->latitude }},{{ $laporan->longitude }}&hl=id&z=16&output=embed"
                                                ...
                                                <div class="xl:col-span-4 xl:border-l xl:border-gray-200 xl:pl-8">
                                                    ...
                                                    <div class="space-y-4 mb-8">
                                                        <h4
                                                            class="text-base font-semibold text-gray-500 mb-3 text-center xl:text-left">
                                                            DETAIL
                                                            LAPORAN</h4>
                                                        <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                                            <div class="flex items-center justify-between">
                                                                <span
                                                                    class="text-sm font-medium text-gray-600 flex items-center"><i
                                                                        class="fas fa-exclamation-triangle text-orange-500 mr-2"></i>Tingkat
                                                                    Kerusakan</span>
                                                                <span
                                                                    class="font-bold text-gray-800 px-3 py-1 bg-white rounded-full text-sm shadow-sm">{{ $laporan->tingkat_kerusakan ? ucfirst($laporan->tingkat_kerusakan) : 'N/A' }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                                            <div class="flex items-center justify-between">
                                                                <span
                                                                    class="text-sm font-medium text-gray-600 flex items-center"><i
                                                                        class="fas fa-tools text-purple-500 mr-2"></i>Jenis
                                                                    Kerusakan</span>
                                                                <span
                                                                    class="font-bold text-gray-800 px-3 py-1 bg-white rounded-full text-sm shadow-sm">{{ $laporan->jenis_kerusakan ? ucfirst($laporan->jenis_kerusakan) : 'N/A' }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    @if ($laporan->keterangan)
                                                        <div class="mb-8">
                                                            ...
                                                            @php
                                                                ...
                                                                $shortNotes = $isLongNotes
                                                                    ? substr($catatan, 0, $limitCatatan) . '...'
                                                                    : $catatan;
                                                            @endphp
                                                            <div class="bg-blue-50 rounded-xl p-5 border border-blue-200">
                                                                <div
                                                                    class="text-blue-800 italic leading-relaxed text-center xl:text-left space-y-2 break-words">
                                                                    <p x-show="!showFullNotes">"{{ $shortNotes }}"</p>
                                                                    <p x-show="showFullNotes" x-collapse>
                                                                        "{{ $catatan }}"</p>
                                                                </div>
                                                                @if ($isLongNotes)
                                                                    <div class="text-center xl:text-left">
                                                                        <button @click="showFullNotes = !showFullNotes"
                                                                            class="text-sm font-semibold text-blue-600 hover:text-blue-800 hover:underline mt-3">
                                                                            <span
                                                                                x-text="showFullNotes ? 'Tutup' : 'Baca Selengkapnya'"></span>
                                                                        </button>
                                                                    </div>
                                                                @endif
                                                            </div>
                                                    ...
                                                    @if ($laporan->status && in_array($statusNama, $allowed_statuses) && !empty($laporan->foto_lanjutan))
                                                        @php
                                                            $fotoLanjutanArray = json_decode(
                                                                $laporan->foto_lanjutan,
                                                                true,
                                                            );
                                                            if (
                                                                json_last_error() !== JSON_ERROR_NONE ||
                                                                !is_array($fotoLanjutanArray)
                                                            ) {
                                                        ...
                                                        <div class="mb-8">
                                                            <h4
                                                                class="text-base font-semibold text-gray-500 mb-4 text-center xl:text-left">
                                                                DOKUMENTASI
                                                                PETUGAS ({{ count($fotoLanjutanArray) }} Foto)</h4>
                                                            <div class="grid grid-cols-2 gap-4">
                                                                @foreach ($fotoLanjutanArray as $index => $fotoLanjutan)
                                                                    <a href="{{ Storage::url('foto_lanjutan/' . $fotoLanjutan) }}"
                                                                        data-fancybox="gallery-petugas-{{ $laporan->id_laporan }}"
                                                                        data-caption="Dokumentasi Petugas {{ $index + 1 }}"
                                                                        class="group relative aspect-square rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 image-overlay">
                                                                        <img data-src="{{ Storage::url('foto_lanjutan/' . $fotoLanjutan) }}"
                                                                            alt="Dokumentasi Petugas {{ $index + 1 }}"
                                                                            class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300">
                                                                        <div
                                                                            class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-300 flex items-center justify-center">
                                                                            <i
                                                                                class="fas fa-expand text-white text-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"></i>
                                                                        </div>
                                                                        <div
                                                    ...
                                                    @if ($laporan->status && $statusNama == 'telah_dikerjakan')
                                                        <div class="mt-8">
                                                            @if ($laporan->feedback)
                                                                <div
                                                                    class="bg-green-50 rounded-xl p-6 border border-green-200 text-center xl:text-left">
                                                                    <h5
                                                                        class="font-bold text-green-800 mb-3 flex items-center justify-center xl:justify-start">
                                                                        <i
                                                                            class="fas fa-heart text-red-500 mr-2"></i>Terima
                                                                        Kasih atas Ulasan Anda!
                                                                    </h5>
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        @for ($i = 1; $i <= 5; $i++)
                                                                            <i
                                                                                class="fas fa-star text-xl {{ $i <= $laporan->rating_kepuasan ? 'text-yellow-400' : 'text-gray-300' }}"></i>
                                                                        @endfor
                                                                        <span
                                                            ...
                                                            @else
                                                                <div
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <i
                                                                            class="fas fa-comment-dots text-green-600 text-xl"></i>
                                                                    </div>
                                                                    <h5 class="font-semibold text-gray-800 mb-2">Pekerjaan
                                                                        Telah Selesai</h5>
                                                                </div>
                                                            @endif
                                                        </div>
                    ...
                    @if ($laporans->hasPages())
                        <div class="mt-12 flex flex-col items-center justify-center space-y-4 fade-in">
                            ...
                            <nav class="inline-flex rounded-xl shadow-lg overflow-hidden border border-gray-200 bg-white"
                                ...
                                @if ($laporans->onFirstPage())
                                    <span
                                        class="relative inline-flex items-center px-3 py-2 text-gray-400 bg-gray-100 cursor-not-allowed select-none">
                                        <span class="sr-only">Sebelumnya</span>
                                        <i class="fas fa-chevron-left h-5 w-5"></i>
                                    </span>
                                @else
                                    <a href="{{ $laporans->previousPageUrl() }}" rel="prev"
                                        class="relative inline-flex items-center px-3 py-2 text-gray-600 hover:bg-gray-100 transition-colors duration-200">
                                        <span class="sr-only">Sebelumnya</span>
                                        <i class="fas fa-chevron-left h-5 w-5"></i>
                                    </a>
                                @endif
                                ...
                                @foreach ($elements as $element)
                                    ...
                                    @if (is_string($element))
                                        <span
                                            class="relative inline-flex items-center px-4 py-2 text-gray-500 bg-white select-none">{{ $element }}</span>
                                    @endif
                                        ...
                                        @foreach ($element as $page => $url)
                                            @if ($page == $laporans->currentPage())
                                                <span aria-current="page"
                                                    class="relative z-10 inline-flex items-center px-4 py-2 bg-primary-navy text-white font-bold shadow-inner">{{ $page }}</span>
                                            @else
                                                <a href="{{ $url }}"
                                                    class="relative inline-flex items-center px-4 py-2 text-primary-navy hover:bg-primary-navy/10 font-semibold transition-colors duration-200">{{ $page }}</a>
                                            @endif
                                        @endforeach
                                    @endif
                                @endforeach
