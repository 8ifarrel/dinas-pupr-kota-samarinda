...
<img src="{{ asset('image/background/portal.jpg') }}" alt="Portal" class="fixed top-0 left-0 w-full h-full object-cover opacity-50 -z-10">
...
<main class="flex flex-col gap-3 lg:gap-4 py-4 lg:py-0 px-3 lg:px-16 w-full">
  ...
  <a href="{{ route('guest.beranda.index') }}" class="flex justify-center">
    ...
    <span class="hidden lg:block">
      <svg width="300" height="90" viewBox="0 0 300 90" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#fcb717" font-size="24" font-family="Arial" class="font-semibold">
          Masuk ke Website
        </text>
      </svg>
    </span>
    ...
    <span class="lg:hidden block">
      <svg width="200" height="60" viewBox="0 0 200 60" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M20 60L0 29.3617L20 0H180L200 30.6667L180 60H20Z" fill="#223468"/>
  
        <text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" fill="#fcb717" font-size="18" font-family="Arial" class="font-semibold">
          Masuk ke Website
        </text>
      </svg>
    </span>
  ...
  <div id="modal-informasi-publik" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        ...
        <div class="flex w-full items-center justify-between p-3 md:p-4 border-b rounded-t border-gray-300">
          <figure class="flex">
            <div class="me-2">
              <lottie-player class="h-[50px] lg:h-[100px]" src="https://lottie.host/dd34a41c-849f-43dc-b0bf-bb9cff0ed814/FrdooYL5sY.json" background="transparent" speed="1" loop autoplay></lottie-player>
            </div>
            <figcaption class="my-auto text-center font-semibold text-base lg:text-2xl">
              Informasi Publik
            </figcaption>
          </figure>
          <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="modal-informasi-publik">
  ...
  <div id="modal-layanan-aplikasi" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <!-- Modal header -->
        <div class="flex w-full items-center justify-between p-3 md:p-4 border-b rounded-t border-gray-300">
          <figure class="flex">
            <div class="me-2">
              <lottie-player class="h-[50px] lg:h-[100px]" src="https://lottie.host/79009bb3-5d07-4937-b043-bdfec1f41bf1/l1GIKi6RYJ.json" background="transparent" speed="1" loop autoplay></lottie-player>
            </div>
            <figcaption class="my-auto text-center font-semibold text-base lg:text-2xl">
              Layanan Aplikasi
            </figcaption>
          </figure>
          <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="modal-layanan-aplikasi">
            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
            </svg>
            <span class="sr-only">Close modal</span>
  ...
  {{-- Modal Layanan Aduan --}}
  <div id="modal-layanan-aduan" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <!-- Modal header -->
        <div class="flex w-full items-center justify-between p-3 md:p-4 border-b rounded-t border-gray-300">
          <figure class="flex">
            <div class="me-2">
              <lottie-player class="h-[50px] lg:h-[100px]" src="https://lottie.host/05a9c4fd-d359-4d7b-acbf-b9d560cf3739/vwyhQ7Wt8H.json" background="transparent" speed="1" loop autoplay></lottie-player>
            </div>
            <figcaption class="my-auto text-center font-semibold text-base lg:text-2xl">
              Layanan Aduan
            </figcaption>
          </figure>
          <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="modal-layanan-aduan">
            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
            </svg>
            <span class="sr-only">Close modal</span>
  ...
  {{-- Modal Media Sosial --}}
  <div id="modal-media-sosial" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-2xl max-h-full">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
        <!-- Modal header -->
        <div class="flex w-full items-center justify-between p-3 md:p-4 border-b rounded-t border-gray-300">
          <figure class="flex">
            <div class="me-2">
              <lottie-player class="h-[50px] lg:h-[100px]" src="https://lottie.host/7fc5c4a3-cad9-414a-8bc5-e097ed4ca67c/zGiBmsHxZj.json" background="transparent" speed="1" loop autoplay></lottie-player>
            </div>
            <figcaption class="my-auto text-center font-semibold text-base lg:text-2xl">
              Media Sosial
            </figcaption>
          </figure>
          <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="modal-media-sosial">
            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
            </svg>
            <span class="sr-only">Close modal</span>
