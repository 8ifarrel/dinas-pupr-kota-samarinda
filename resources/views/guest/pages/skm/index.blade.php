        ...
        <div class="flex flex-wrap justify-center gap-5 tv-vertical:gap-10">
          ...
          @foreach ($options as $option)
            <div>
              ...
              <label for="{{ $option['id'] }}"
                class="bg-white flex cursor-pointer flex-col items-center gap-2 rounded-2xl border p-4 shadow-md transition peer-checked:ring-2 peer-checked:ring-brand-blue hover:scale-105 active:scale-95 group tv-vertical:p-8 tv-vertical:gap-4">
