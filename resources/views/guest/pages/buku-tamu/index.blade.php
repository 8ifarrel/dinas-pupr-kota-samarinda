  ...
  <section class="relative h-screen flex flex-col items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col items-center w-full xl:gap-6">
      <div class="text-center">
        ...
        <h1 class="xl:mb-5 xl:text-6xl 2xl:text-7xl 3xl:text-8xl font-semibold text-brand-blue">
          Buku Tamu <br> Digital
        </h1>
        <p class="xl:mb-6 2xl:mb-8 3xl:mb-10 xl:text-xl 2xl:text-2xl 3xl:text-3xl font-semibold text-gray-700 mx-auto">
