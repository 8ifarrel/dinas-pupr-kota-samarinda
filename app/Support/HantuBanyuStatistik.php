...
/**
 * Perhitungan statistik pengaduan Hantu Banyu.
 * Dipakai bersama oleh halaman statistik E-Panel (global) dan halaman publik
 * (dibatasi ke satu kelurahan bila $kelurahanId diberikan).
 */
class HantuBanyuStatistik
{
    /**
