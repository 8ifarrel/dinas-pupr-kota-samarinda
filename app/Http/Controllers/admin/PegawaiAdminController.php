...
class PegawaiAdminController extends Controller
{
	public function index(Request $request)
	{
		...
		if ($jabatan->nama_jabatan === 'Kepala Dinas') {
	...
	public function create(Request $request)
	{
		...
		abort_unless($jabatan->nama_jabatan !== 'Kepala Dinas', 403, 'Kepala Dinas tidak dapat menambah pegawai.');
	...
	public function store(Request $request)
	{
		...
		abort_unless(strtolower($jabatan->nama_jabatan) !== 'kepala dinas', 403, 'Kepala Dinas tidak dapat menambah pegawai.');
		...
		$data = $request->safe()->except(['foto_pegawai', 'username', 'email', 'password']);
