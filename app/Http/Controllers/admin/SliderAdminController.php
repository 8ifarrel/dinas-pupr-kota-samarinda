...
class SliderAdminController extends Controller
{
    ...
    {
        $page_title = "Slider";
        $page_description = "Kelola gambar slider yang ditampilkan di halaman utama website.";
    ...
    public function create()
    {
        ...
        $page_description = "Tambah gambar slider baru untuk ditampilkan di halaman utama.";
    ...
    public function edit($id)
    {
        ...
        $page_description = "Edit gambar slider yang sudah ditampilkan di halaman utama.";
        $slider = Slider::findOrFail($id);
