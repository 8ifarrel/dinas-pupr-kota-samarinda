...
class LaporanGuestController extends Controller
{
    ...
    // {
    //     $laporan = Laporan::with(['kecamatan', 'kelurahan', 'pelapor', 'status'])
    //         ->where('id_laporan', $id_laporan)
    //         ->firstOrFail();

    //     $data = ['laporan' => $laporan];
    //     $pdf = Pdf::loadView('laporan.invoice-pdf', $data);
    ...
    {
        $meta_description = "Cek Laporan.";
		$page_title = "Cek Laporan";
        $query = Laporan::with(['kecamatan', 'kelurahan', 'pelapor', 'status'])
        ...
        return view('guest.pages.jalan-peduli.laporan.data', compact('laporans'), [
