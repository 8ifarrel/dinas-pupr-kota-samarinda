...
/**
 * SKM khusus layanan Hantu Banyu.
 *
 * Responden menilai pada skala 1-4. Seluruh perhitungannya ditulis di berkas
 * ini supaya halaman ini berdiri sendiri dan tidak bergantung pada berkas lain.
 *
 * Id layanan diambil dari controller pengaduan supaya nilainya tidak ditulis
 * ulang di dua tempat: bila pemetaan layanannya berubah, halaman ini ikut.
 */
class HantuBanyuSKMAdminController extends Controller
{
  /** Skala penilaian tertinggi yang bisa diberikan responden. */
  private const SKALA_MAKSIMUM = 4;
  ...
  {
    $layananId = (new HantuBanyuPengaduanGuestController)->layanan_id;
    ...
    return view('admin.pages.hantu-banyu.skm.index', [
      ...
      'page_title' => 'Survei Kepuasan Masyarakat pada Hantu Banyu',
      'page_description' => 'Penilaian pelapor setelah mengirim pengaduan pada layanan Hantu Banyu.',
    ]);
  }

  /** Sebaran jumlah responden pada tiap nilai 1-4. */
