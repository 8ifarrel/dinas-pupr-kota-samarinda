...
class LPSEAdminController extends Controller
{
   public function index()
    {
    $lpses = LPSE::orderBy('created_at', 'desc')->get();
    ...
    return redirect()->route('admin.lpse.index')->with('success', 'Data berhasil disimpan!');
    }
   ...
   public function update(Request $request, $id)
{
    ...
    return redirect()->route('admin.lpse.index')->with('success', 'Data berhasil diperbarui.');
}
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.lpse.index')->with('success', 'Data LPSE berhasil dihapus.');
    }
}